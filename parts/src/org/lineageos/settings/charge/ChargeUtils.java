...
public class ChargeUtils {
    ...
    public SafetyCheckResult performSafetyChecks() {
        ...
        return new SafetyCheckResult(true, context.getString(R.string.charge_safety_ok));
    }
    ...
    private boolean isWiredChargerConnected() {
        ...
        boolean wired = chargePlug == BatteryManager.BATTERY_PLUGGED_AC
                || chargePlug == BatteryManager.BATTERY_PLUGGED_USB
                || chargePlug == BatteryManager.BATTERY_PLUGGED_DOCK;
        Log.d(TAG, "plugged=" + chargePlug + " wired=" + wired);
        return wired;
    }
    ...
    private int getBatteryTemperature() {
        ...
        if (tempStr != null) {
            try {
                ...
                Log.e(TAG, "Failed to parse battery temperature", e);
            }
        }
    ...
    private int getBatteryCapacity() {
        ...
        if (capacityStr != null) {
            try {
                ...
                Log.e(TAG, "Failed to parse battery capacity", e);
            }
        }
