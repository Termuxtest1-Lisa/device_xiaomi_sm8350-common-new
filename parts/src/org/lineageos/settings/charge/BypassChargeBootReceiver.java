...
public class BypassChargeBootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!devOptionsEnabled) {
            Log.d(TAG, "Developer options disabled, forcing bypass charging off");
            new ChargeUtils(context).enableBypassCharge(false);
        }

        BypassChargeTileService.updateTile(context);
    }
}
